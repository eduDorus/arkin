...
impl From<PositionInfoRequest> for Request {
    fn from(request: PositionInfoRequest) -> Request {
        let mut params = vec![];
...
impl Default for PositionInfoRequest {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    fn trade_account_convert_to_request_test() {
        ...
        let request: Request = PositionInfoRequest::new().recv_window(5000).credentials(&credentials).into();
