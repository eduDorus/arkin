...
pub struct BinanceSwapStreamEvent {
    pub stream: String,
    pub data: BinanceSwapEvent, // Tagged enum based on "e" field
}
...
mod tests {
    ...
    fn test_binance_futures_trade() {
        ...
        let _ = serde_json::from_str::<BinanceSwapStreamEvent>(json_data).unwrap();
    }
    ...
    fn test_binance_futures_ticker_data() {
        ...
        let _ = serde_json::from_str::<BinanceSwapEvent>(json_data).unwrap();
    }
}
