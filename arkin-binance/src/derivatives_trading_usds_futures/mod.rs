...
use crate::common::{
    ...
    constants::{
        ...
        DERIVATIVES_TRADING_USDS_FUTURES_WS_API_PROD_URL, DERIVATIVES_TRADING_USDS_FUTURES_WS_API_TESTNET_URL,
        DERIVATIVES_TRADING_USDS_FUTURES_WS_STREAMS_PROD_URL, DERIVATIVES_TRADING_USDS_FUTURES_WS_STREAMS_TESTNET_URL,
    },
...
impl DerivativesTradingUsdsFuturesWsStreams {
    ...
    #[must_use]
    pub fn from_config(mut config: ConfigurationWebsocketStreams) -> websocket_streams::WebsocketStreamsHandle {
        config.user_agent = build_user_agent("derivatives-trading-usds-futures");
        if config.ws_url.is_none() {
    ...
    #[must_use]
    pub fn production(mut config: ConfigurationWebsocketStreams) -> websocket_streams::WebsocketStreamsHandle {
        config.ws_url = Some(DERIVATIVES_TRADING_USDS_FUTURES_WS_STREAMS_PROD_URL.to_string());
    ...
    #[must_use]
    pub fn testnet(mut config: ConfigurationWebsocketStreams) -> websocket_streams::WebsocketStreamsHandle {
