...
pub struct Caches {
    ...
    pub account_id: Cache<Uuid, Arc<Account>>,
    pub strategy_id: Cache<Uuid, Arc<Strategy>>,
...
impl Caches {
    pub fn new(capacity: u64) -> Self {
        Self {
            ...
            account_id: Cache::new(capacity),
            strategy_id: Cache::new(capacity),
...
pub struct Buffers {
    ...
    pub audits: Arc<Mutex<Vec<Event>>>,
}
