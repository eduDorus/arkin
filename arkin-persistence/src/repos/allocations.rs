...
impl From<Allocation> for AllocationRow {
    fn from(allocation: Allocation) -> Self {
        Self {
            ...
            strategy_id: allocation.strategy_id.to_string(),
...
impl DBManager {
    pub async fn insert_allocation(&self, allocation: Allocation) -> Result<()> {
        ...
        sqlx::query!(
            r#"
            INSERT INTO allocations (event_time, instrument_type, venue, base, quote, maturity, strike, option_type, strategy_id, notional)
