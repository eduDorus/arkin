...
pub struct ForecastAllocationOptim {
    pubsub: Arc<PubSub>,
...
#[async_trait]
impl AllocationOptim for ForecastAllocationOptim {
...
#[async_trait]
impl RunnableService for ForecastAllocationOptim {
...
#[async_trait]
impl AllocationService for ForecastAllocationOptim {}
