...
pub trait Accounting: Send + Sync {
    ...
    /// Returns the available margin balance of all assets on a venue
    ...
    async fn position_value(&self, venue: &Arc<Venue>) -> HashMap<Arc<Instrument>, Decimal>;
    ...
    // async fn instrument_value(&self, instrument: &Arc<Instrument>) -> Decimal;
    ...
    async fn strategy_position_value(&self, strategy: &Arc<Strategy>) -> HashMap<Arc<Instrument>, Decimal>;
